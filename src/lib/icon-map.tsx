// @ts-nocheck — vendored Fluid Functionalism icon registry: maps icons from
// several libraries (lucide/tabler/phosphor/hugeicons/untitledui) whose
// propTypes (size: string|number) don't satisfy this repo's strict TS. The
// runtime is fine; skip type-checking this internal infra file.
"use client";
