      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="font-main flex flex-col gap-10 text-base leading-relaxed text-[#555555]">
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">Agreement to Our Legal Terms</h2>
            <p>
              We are Rivet. Inc, doing business as Rivet ("Company," "we," "us," "our").
            </p>
            <p>
            ...
            <p>Rivet is a visual editor to design in code.</p>
            <p>
              You can contact us by phone at (707) 861-0747, email at{' '}
              <a href="mailto:support@rivet.design" className="text-foreground underline underline-offset-2">
                support@rivet.design
              </a>
              , or by mail to Rivet. Inc.
            </p>
            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether
              personally or on behalf of an entity ("you"), and Rivet. Inc, concerning your access
            ...
            <p>
              ...
              of each such change. It is your responsibility to periodically review these Legal
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">1. Our Services</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">2. Intellectual Property Rights</h2>
            <h3 className="font-medium text-foreground">Our intellectual property</h3>
            <p>
            ...
            <h3 className="font-medium text-foreground">Your use of our Services</h3>
            <p>
            ...
            <h3 className="font-medium text-foreground">Your submissions</h3>
            <p>
            ...
            <p>
              <strong className="text-foreground">Submissions:</strong> By directly sending us any
            ...
            <p>
              <strong className="text-foreground">You are responsible for what you post or upload:</strong>{' '}
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">3. User Representations</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">4. User Registration</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">5. Purchases and Payment</h2>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">6. Subscriptions</h2>
            <h3 className="font-medium text-foreground">Billing and Renewal</h3>
            <p>
            ...
            <h3 className="font-medium text-foreground">Free Trial</h3>
            <p>
              We offer a free trial to new users who register with the Services. You have the option
              of upgrading your account if you'd like to.
            </p>
            ...
            <h3 className="font-medium text-foreground">Fee Changes</h3>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">7. Software</h2>
            <p>
              ...
              any software. You may not reproduce or redistribute any software except in accordance
              with the EULA or these Legal Terms.
            </p>
          </section>

          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">8. Prohibited Activities</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">9. User Generated Contributions</h2>
            <p>
              ...
              the Services' Privacy Policy. When you create or make available any Contributions, you
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">10. Contribution License</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">11. Social Media</h2>
            <p>
              ...
              Services via your account, including without limitation any friend lists and (2) we
              may submit to and receive from your Third-Party Account additional information to the
              ...
              have also registered to use the Services. You can deactivate the connection between
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">12. Services Management</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">13. Privacy Policy</h2>
            <p>
              ...
              or other requirements governing personal data collection, use, or disclosure that
              differ from applicable laws in the United States, then through your continued use of
              the Services, you are transferring your data to the United States, and you expressly
              consent to have your data transferred to and processed in the United States.
            </p>
          </section>

          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">14. Term and Termination</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">15. Modifications and Interruptions</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">16. Governing Law</h2>
            <p>
              ...
              to be entirely performed within the State of California, without regard to its
              conflict of law principles.
            </p>
          </section>

          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">17. Dispute Resolution</h2>
            <h3 className="font-medium text-foreground">Informal Negotiations</h3>
            <p>
            ...
            <h3 className="font-medium text-foreground">Binding Arbitration</h3>
            <p>
              ...
              arbitration will take place in California. Except as otherwise provided herein, the
            ...
            <p>
              ...
              shall be commenced or prosecuted in the state and federal courts located in California,
            ...
            <p>
              ...
              Services be commenced more than one (1) year after the cause of action arose. If this
            ...
            <h3 className="font-medium text-foreground">Restrictions</h3>
            <p>
            ...
            <h3 className="font-medium text-foreground">Exceptions to Informal Negotiations and Arbitration</h3>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">18. Corrections</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">19. Disclaimer</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">20. Limitations of Liability</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">21. Indemnification</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">22. User Data</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              original signature or delivery or retention of non-electronic records, or to payments
              or the granting of credits by any means other than electronic means.
            </p>
          </section>

          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">24. California Users and Residents</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">25. Miscellaneous</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-lg font-medium text-foreground">26. Contact Us</h2>
            <p>
            ...
            <div className="flex flex-col gap-1 text-foreground">
              <span>Rivet. Inc</span>
              <span>Phone: (707) 861-0747</span>
              <a href="mailto:support@rivet.design" className="underline underline-offset-2">
                support@rivet.design
              </a>
            </div>
          </section>
