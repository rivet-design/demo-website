...
const Connectors = () => {
  ...
  return (
    <section className="w-full max-w-xl rounded-lg border border-border bg-main shadow-sm">
      {/* Header */}
      <header className="flex items-start justify-between gap-4 border-b border-border px-6 py-5">
        ...
        <span className="type-overline shrink-0 rounded-full bg-secondary px-2.5 py-1 text-muted-foreground">
          ...
          return (
            <li key={source.id} className="flex items-center gap-4 px-6 py-4">
              ...
              <button
                ...
                className={
                  isConnected
                    ? 'type-label shrink-0 rounded-lg border border-border px-3.5 py-2 text-accent-foreground transition-colors hover:bg-secondary'
